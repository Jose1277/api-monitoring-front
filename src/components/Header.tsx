...
export default function Header() {
    ...
    return (
        <header className="relative flex w-full items-center justify-between border-b border-white/10 bg-white/5 px-6 py-3 backdrop-blur-md">
            {/* Left */}
            <span className="md:text-sm md:font-semibold md:tracking-widest md:text-white/90 uppercase text-xs text-white/90 font-medium">
                API Monitoring
            </span>

            {/* Center */}
            <div className="pointer-events-none absolute left-1/2 -translate-x-1/2">
                <span className="md:text-xs tracking-wide text-white/50 whitespace-nowrap">
                    {endpointCount === null
                        ? 'Monitoring 0 APIs'
